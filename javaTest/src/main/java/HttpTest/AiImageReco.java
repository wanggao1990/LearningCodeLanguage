    ...
    public String uploadFile(File file, String RequestURL) {
        ...
        try{
            ...
            if(file != null) {
                ...
                System.out.println(TAG + "response code:" + res);
                if(res==200)
                {
                    System.out.println(TAG + "request success");
                    ...
                    System.out.println(TAG + "request error");
                 }
            }
...
public class AiImageReco {
    public static void main(String[] args) {
        try {
            String imgPath = "C:\\Users\\wanggao\\Desktop\\1.png";
            //  String imgPath = "C:\\Users\\wanggao\\Desktop\\red2x2.jpg";
            String httpUrl = "http://192.168.3.179:8080/dataplatform/app/api/upload.do";

            Map<String, String> params = new HashMap<>();
            params.put("filetype", "0");

            Map<String, File> files = new HashMap<>();
            files.put("upload", new File(imgPath));

            UploadUtil uploadApi = new UploadUtil();
            String res = uploadApi.post(httpUrl, params, files);
